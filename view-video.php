...
<head>
    ...
    <link rel="canonical" href="https://www.mojoesan.com/view-video/<?php echo $id ?>" />
    <link rel="alternate" href="https://www.mojoesan.com/view-video/<?php echo $id ?>" hreflang="th-TH" />
    ...
    <script type="application/ld+json">
        {
            ...
            "itemListElement": [{
                    ...
                    "position": 2,
                    "name": "พอดคาสต์",
                    "item": "https://www.mojoesan.com/esan-clip/"
                },
                {
                    "@type": "ListItem",
                    "position": 3,
            ...
            <div class="row">
                <div class="col-lg-8 my-1">
                    ...
                    <aside class="site mt-4">
                        <div class="buttons">
                            <a class="fb" href="https://www.facebook.com/sharer/sharer.php?u=https://www.mojoesan.com/view-video/<?php echo $id ?>" title="Join us on Facebook" onclick="window.open(this.href, 'facebook-share','width=500,height=300');return false;"><i class="fab fa-facebook" aria-hidden="true"></i>facebook</a>
                            <a class="tw" href="https://twitter.com/share?text=title &url=https://www.mojoesan.com/view-video/<?php echo $id ?>" title="Join us on Twitter" target="_blank" onclick="window.open(this.href, 'twitter-share', 'width=500,height=300');return false;"><i class="fab fa-twitter" aria-hidden="true"></i>twitter</a>
                            <a class="i-line" href="https://social-plugins.line.me/lineit/share?url=https://www.mojoesan.com/view-video/<?php echo $id ?>" title="Join us on line" onclick="window.open(this.href, 'facebook-share','width=500,height=500');return false;"><i class="fab fa-line" aria-hidden="true"></i>line</a>
                        </div>
                    </aside>
                </div>
