            ...
            foreach ($fields as $img => $value) {
                if ($_FILES[$img]['name']) {
                    ...
                    if (in_array($extension, $allowed_extension)) {
                        ...
                        if ($imgResult) {
                            $message = "มีการสมัครสมาชิก รอยืนยัน mojoesan.com";
                            $token = "BhQ1MZhAIFbz0Val8snCD7Z4TZY4WyOBtJMdlNX1VTC";
                            $ch = curl_init();
...
<head>
    ...
    <title>เข้าสู่ระบบ Mojo Esan</title>
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <div class="form-group row">
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                    <input type="text" name="firstname" class="form-control form-control-user" id="exampleFirstName" placeholder="ชื่อ" required>
                                                </div>
                                                <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <div class="form-group row">
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                    <input type="text" name="email" class="form-control form-control-user" id="exampleFirstName" placeholder="อีเมล" required>
                                                </div>
                                                <div class="col-sm-6">
                                                    <input type="text" name="province" class="form-control form-control-user" id="exampleLastName" placeholder="จังหวัด" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
