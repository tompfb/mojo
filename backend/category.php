...
$category = $categoryFn->getAllCategory();
$countArts = $categoryFn->countCategory();
...
$categoryPage =  $categoryFn->getCategoryPage($limit);
...
<body id="page-top">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="#" data-toggle="modal" data-target="#createModal" class="btn btn-primary btn-icon-split">
                                ...
                                <span class="text">สร้างหมวดหมู่</span>
                            </a>
                        </div>
                    </div>
                    <!-- DataTales Example -->
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        while ($category = $categoryPage->fetch_assoc()) {
                                        ?>
                                            <tr>
    ...
    <div class="modal small fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="functions/category-create.php" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-warning" type="submit">สร้างหมวดหมู่าง</button>
    ...
    <div class="modal small fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="functions/category-edit.php">
                    <div class="modal-header">
                        <h3>แก้ไขหมวดหมู่</h2>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-default" data-dismiss="modal" aria-hidden="true">ยกเลิก</button>
                        <button class="btn btn-warning" type="submit">แก้ไขหมวดหมู่</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal small fade" id="delModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h3><i class="fa fa-warning modal-icon"></i>คุณแน่ใจหรือที่จะลบหรือไม่ - <span class="text-danger" id="modal_span"></span></h3>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-default" data-dismiss="modal" aria-hidden="true">ยกเลิก</button>
                    <a href="#" class="btn btn-danger" id="modalDelete">ลบหมวดหมู่</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        //     var id = $(this).data('id');
        //     $('#modalCreate').attr('href', 'category-create.php?id=' + id);
        // })
        ...
        // $('.edit').click(function() {
        //     var id = $(this).data('id');
        //     $('#modalEdit').attr('href', 'functions/category-edit.php?id=' + id);
        // })
        $('.trash').click(function() {
            var id = $(this).data('id');
            $('#modalDelete').attr('href', 'functions/category-delete.php?id=' + id);
        })
    </script>
</body>
