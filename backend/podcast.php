                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center">
                                ...
                                if ($userRole == 1) {
                                    ...
                                    $f = $_SESSION['userid'];
                                    $fetchpodcasts = mysqli_query($conn, "SELECT * FROM podcasts where user_id = $f ORDER BY id DESC");
                                    while ($row = mysqli_fetch_assoc($fetchpodcasts)) {
                                        $location = $row['location'];
                                        $Podidname = $row['title'];
                                        $Pimg = $row['image_podcast'];
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select type="text" class="form-control" name="category">
                                ...
                                <option value="3">ออนซอนอีสาน</option>
                                <option value="4">หมอลำพาม่วน</option>
                            </select>
                        </div>
