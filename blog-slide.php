<section class=" position-relative">
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        $first = mysqli_fetch_array($query_first);
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                if ($first['category_id']) {
                    $cate_id =  $first['category_id'];
                    $use_id =  $first['user_id'];

                    $sql_category = "SELECT * FROM category WHERE id = $cate_id ";
                        ...
                        <div class="row">
                            <div class="col-lg-6 position-relative">
                                <div class="carousel-cardtext">
                                    ...
                                    <h3><?php echo trim(strip_tags(mb_substr($first['topic_name'], 0, 30, 'utf-8'))) ?>..</h3>
                        ...
                        <div class="row">
                            <div class="col-lg-6 position-relative">
                                <div class="carousel-cardtext">
                                    ...
                                    <h3><?php echo trim(strip_tags(mb_substr($two['topic_name'], 0, 30, 'utf-8'))) ?>..</h3>
